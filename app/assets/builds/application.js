...
%o`, message, error2, detail);
  ...
  var DynamicFormController = class extends Controller {
    ...
    add_person(e2) {
      ...
      var content = this.personTemplateTarget.innerHTML.replace(/NEW_RECORD/g, (/* @__PURE__ */ new Date()).getTime().toString()).replace(/<option value="Partner">/, '<option value="Partner" selected="selected">');
      if (this.element.getElementsByClassName("dynamic-form-person").length > 1) {
        console.log("adding child");
        adding_child = true;
        content = this.personTemplateTarget.innerHTML.replace(/NEW_RECORD/g, (/* @__PURE__ */ new Date()).getTime().toString()).replace(/<option value="Child">/, '<option value="Child" selected="selected">');
      }
    ...
    add_boat(e2) {
      e2.preventDefault();
      var content = this.boatTemplateTarget.innerHTML.replace(/NEW_RECORD/g, (/* @__PURE__ */ new Date()).getTime().toString());
    ...
    add_installment(e2) {
      e2.preventDefault();
      var content = this.installmentTemplateTarget.innerHTML.replace(/NEW_RECORD/g, (/* @__PURE__ */ new Date()).getTime().toString());
  ...
  window.Trix = no;
  no.config.toolbar.getDefaultHTML = toolbarDefaultHTML;
  function toolbarDefaultHTML() {
    const { lang } = no.config;
