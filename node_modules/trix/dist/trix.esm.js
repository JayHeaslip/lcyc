...
class FlakyAndroidKeyboardDetector {
  ...
  insertingLongTextAfterUnidentifiedChar() {
    ...
    return this.isBeforeInputInsertText() && this.previousEventWasUnidentifiedKeydown() && ((_this$event$data = this.event.data) === null || _this$event$data === void 0 ? void 0 : _this$event$data.length) > 100;
  }
